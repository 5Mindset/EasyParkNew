...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        ...
        <form action="{{ route('students.index') }}" method="GET" class="position-relative" style="max-width: 250px; width: 100%;">
            <input type="text" name="search" class="form-control ps-5" placeholder="Cari mahasiswa..." value="{{ request('search') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="width: 50px; height: 50px;">
                                    @if ($student->image)
                                    <img src="{{ asset('storage/' . $student->image) }}" alt="Foto" class="rounded-circle w-100 h-100 object-fit-cover">
                                    @else
