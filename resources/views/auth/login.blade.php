...
<body class="min-h-screen flex flex-col md:flex-row">
    <!-- Left section -->
    <div class="w-full md:w-[55%] min-h-[60vh] md:min-h-screen relative flex flex-col justify-center items-center md:items-start px-6 md:px-16 py-16 md:py-20 text-white"
        ...
        <!-- Content -->
        <img src="{{ asset('images/logo.png') }}" alt="Easy Park logo" class="w-28 md:w-36 mb-6 z-10 relative" />
        <h1 class="text-3xl md:text-4xl font-extrabold mb-3 md:mb-4 drop-shadow-lg max-w-md text-center md:text-left z-10 relative">
            Selamat Datang di Easy Park!
        </h1>
        <p class="text-base md:text-lg mb-6 md:mb-8 max-w-md leading-relaxed drop-shadow-md text-center md:text-left z-10 relative">
    ...
    <div class="w-full md:w-[45%] min-h-[40vh] md:min-h-screen flex flex-col justify-center items-center px-6 md:px-16 py-10 md:py-0 bg-white">
        <h1 class="text-[#222222] font-bold text-xl md:text-2xl mb-1 md:mb-2 text-center">Hallo selamat datang!!</h1>
        <p class="text-[#555555] text-sm mb-6 md:mb-8 max-w-xs text-center">Mari mulai memakirkan kendaraan anda bersama kami</p>
