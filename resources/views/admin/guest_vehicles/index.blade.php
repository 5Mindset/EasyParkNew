...
@section('content')
    ...
    <div class="container py-5">
        ...
        <h4 class="fw-bold mb-3">Daftar Kendaraan Tamu</h4>
        ...
        <div class="d-flex justify-content-end flex-wrap gap-2 mb-3">
            ...
            <form action="{{ route('guest-vehicles.index') }}" method="GET">
            ...
            <div class="card-body p-4">
                ...
                @if ($guestVehicles->count())
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                @foreach ($guestVehicles as $index => $vehicle)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('guest-vehicles.show', $vehicle->id) }}"

                                                class="btn btn-sm btn-info" aria-label="Lihat detail kendaraan tamu">
                    ...
                    <div class="mt-3">
                        ...
                        {{ $guestVehicles->withQueryString()->links('pagination::tailwind') }}
                ...
                @else
                    ...
                    <div class="text-center text-muted py-4">
                        ...
                        <p class="mt-2 mb-0">Tidak ada data kendaraan tamu yang ditemukan.</p>
