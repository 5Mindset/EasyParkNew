<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed {{ request()->is('officers*') || request()->is('students*') ? '' : 'collapsed' }}" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
            ...
            <ul id="components-nav" class="nav-content collapse {{ request()->is('officers*') || request()->is('students*') ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('officers.index') }}" class="{{ request()->routeIs('officers.*') ? 'active' : '' }}">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed {{ request()->is('vehicle-types*') || request()->is('vehicle-brands*') || request()->is('vehicle-models*') || request()->is('vehicles*') || request()->is('parking-areas*') ? '' : 'collapsed' }}" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
            ...
            <ul id="forms-nav" class="nav-content collapse {{ request()->is('vehicle-types*') || request()->is('vehicle-brands*') || request()->is('vehicle-models*') || request()->is('vehicles*') || request()->is('parking-areas*') ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('vehicle-types.index') }}" class="{{ request()->routeIs('vehicle-types.*') ? 'active' : '' }}">
                        <i class="bi bi-circle"></i><span>Tipe Kendaraan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('vehicle-brands.index') }}" class="{{ request()->routeIs('vehicle-brands.*') ? 'active' : '' }}">
                        <i class="bi bi-circle"></i><span>Merek Kendaraan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('vehicle-models.index') }}" class="{{ request()->routeIs('vehicle-models.*') ? 'active' : '' }}">
                ...
                <li>
                    <a href="{{ route('parking-areas.index') }}" class="{{ request()->routeIs('parking-areas.*') ? 'active' : '' }}">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed {{ request()->is('parking-records*') || request()->is('guest-vehicles*') ? '' : 'collapsed' }}" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
            ...
            <ul id="tables-nav" class="nav-content collapse {{ request()->is('parking-records*') || request()->is('guest-vehicles*') ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('parking-records.index') }}" class="{{ request()->routeIs('parking-records.*') ? 'active' : '' }}">
                        <i class="bi bi-circle"></i><span>Mahasiswa Parkir</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('guest-vehicles.index') }}" class="{{ request()->routeIs('guest-vehicles.*') ? 'active' : '' }}">
