    ...
    <div class="card border-0 shadow rounded-4 mb-4">
        <div class="card-body p-4">
            @if ($parkingRecords->count())
                        ...
                        <tbody>
                            @foreach ($parkingRecords as $index => $record)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('parking-records.show', $record->id) }}" class="btn btn-sm btn-info">
                ...
                <div class="mt-3">
                    {{ $parkingRecords->links('pagination::bootstrap-5') }}
                </div>
            @else
                <div class="text-center text-muted py-4">
                    <i class="bi bi-info-circle fs-4"></i>
                    <p class="mb-0">Data parkir tidak ditemukan.</p>
                </div>
            @endif
        </div>
    </div>
