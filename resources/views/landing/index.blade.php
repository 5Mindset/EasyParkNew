...
<body class="bg-[#053a7c]">
    ...
    <header class="fixed top-0 left-0 right-0 bg-[#053a7c] shadow z-50">
        ...
        <div class="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16 flex items-center justify-between py-6">
            ...
            <div class="flex items-center space-x-2">
                ...
                <img alt="Easy Park logo" class="w-[180px] h-[40px] object-contain"
                    src="{{ asset('/images/logo.png') }}" width="180" height="40" height="40" />
                ...
                <ul class="hidden md:flex items-center space-x-8 text-white text-sm font-normal">
                    ...
                    <li>
                        <a class="border border-white rounded-lg px-5 py-2 text-white hover:bg-white hover:text-[#053a7c] transition-colors duration-300"
                            href="https://drive.google.com/uc?export=download&id=1zyRjCGCFlZBFSKrZbSdiTi-IhgZCcPZ5"
    ...
    <main id="beranda"
        ...
        <div class="text-white max-w-xl md:max-w-lg lg:max-w-xl">
            ...
            <p class="text-sm sm:text-base mb-8 max-w-md">Nikmati layanan parkir kami yang luas, aman, dan strategis.
            </p>
        ...
        <div class="mt-10 md:mt-0">
            ...
            <img alt="Mobil Putih" class="w-[600px] max-w-full h-auto" src="{{ asset('/images/mobilputih.png') }}"
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <section class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-12">
                ...
                <div class="flex justify-center md:justify-start">
                    ...
                    <img alt="Illustration of an orange van stopped at a parking barrier with a security guard holding a phone, city buildings and trees in the background"
                        class="w-full max-w-[600px] h-auto" src="{{ asset('images/parkinglot.png') }}" width="600"
                        height="300" />
            ...
            <section class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div class="flex justify-center md:justify-end pr-6">
                    ...
                    <img alt="Logo Kerjasama" class="w-full max-w-[500px] h-auto"
                        src="{{ asset('/images/bekerjasama.png') }}" width="500" height="500" />
    ...
    <section id="keunggulan" class="bg-[#073b82] text-white">
        ...
        <div
            ...
            <div class="md:w-1/2 flex justify-center md:justify-end">
                ...
                <img alt="Ilustrasi mobil parkir" class="w-full max-w-[600px] h-auto"
                    src="{{ asset('/images/car.png') }}" width="600" height="350" loading="lazy" />
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-y-12 gap-x-8 text-center max-w-6xl mx-auto">
                ...
                <div class="flex flex-col items-center px-4">
                    ...
                    <div class="bg-[#4a90e2] rounded-full p-6 mb-5 inline-flex">
                        ...
                        <img alt="Ikon smartphone" class="w-12 h-12 object-contain"
                            src="{{ asset('/images/Smartphone.png') }}" width="48" height="48"
                            loading="lazy" />
                ...
                <div class="flex flex-col items-center px-4">
                    ...
                    <div class="bg-[#4a90e2] rounded-full p-6 mb-5 inline-flex">
                        ...
                        <img alt="Ikon riwayat kendaraan" class="w-12 h-12 object-contain"
                            src="{{ asset('/images/histori.png') }}" width="48" height="48" loading="lazy" />
                ...
                <div class="flex flex-col items-center px-4">
                    ...
                    <div class="bg-[#4a90e2] rounded-full p-6 mb-5 inline-flex">
                        ...
                        <img alt="Ikon kode QR kendaraan" class="w-12 h-12 object-contain"
                            src="{{ asset('/images/QrCode.png') }}" width="48" height="48" loading="lazy" />
                ...
                <div class="flex flex-col items-center px-4">
                    ...
                    <div class="bg-[#4a90e2] rounded-full p-6 mb-5 inline-flex">
                        ...
                        <img alt="Ikon manajemen kendaraan" class="w-12 h-12 object-contain"
                            src="{{ asset('/images/upload.png') }}" width="48" height="48" loading="lazy" />
    ...
    <section class="bg-white text-black relative overflow-hidden"
        ...
        <div
            ...
            <div class="relative flex justify-center lg:justify-start w-full lg:w-1/2">
                ...
                <img alt="Ilustrasi aplikasi EasyPark" class="max-w-md w-full h-auto ml-auto"
                    src="{{ asset('/images/Apps.png') }}" width="400" height="400" style="" />
...
<footer class="bg-[#043A7C] text-white pt-16 pb-10">
    ...
    <div class="max-w-7xl mx-auto px-6 text-center">
        ...
        <div class="mt-6 flex justify-center">
            ...
            <img alt="Logo Politeknik Negeri Jember" class="h-16 object-contain"
                src="{{ asset('/images/polije.png') }}" width="auto" height="64" />
    ...
    <div
        ...
        <div>
            ...
            <p>
                ...
                LINGKUNGAN KAMPUS, TANPA PERLU KARTU FISIK ATAU ANTRE PANJANGâ€”CUKUP DENGAN APLIKASI INI, PARKIR
                MENJADI
